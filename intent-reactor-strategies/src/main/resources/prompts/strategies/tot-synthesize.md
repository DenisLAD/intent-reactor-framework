...
- Don't just summarize the steps — create a COMPLETE, READY-TO-USE solution
- The final answer must be self-contained: the reader should not need to know about the intermediate steps
- For plans: include all necessary sections (characters, structure, key events, ending, etc.) with concrete details
